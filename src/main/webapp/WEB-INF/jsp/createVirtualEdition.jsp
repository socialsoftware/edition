...
<title><spring:message code="virtualeditionlist.createvirtual" /></title>
...
<body>
	...
	<div class="container">
		<form class="form-horizontal" method="POST" action="/virtualeditions">
			<fieldset>
				<legend><spring:message code="virtualeditionlist.createvirtual" /></legend>
				<c:if test="${error}">
				...
				<div class="control-group">
					<div class="controls">
						<button type="submit" class="btn"><spring:message code="virtualeditionlist.createvirtual" /></button>
					</div>
				</div>
			</fieldset>
		</form>
