...
<ul>
	...
	<ul>
		<li>University of Coimbra, Centre for Portuguese Literature
			(CLP): Colloquium &ldquo;Estranhar Pessoa com as Materialidades da
			Literatura&rdquo; May 25, 2012; coords. Manuel Portela and Osvaldo
			Manuel Silvestre)</li>
	</ul>
	...
	<ul>
		...
		<li>University of Western Sydney, School of Humanities and
			...
			the Database&rdquo;, organized by the Project &ldquo;<a
			...
			target="new">Creative Nation: Writers and Writing in the New
				Media Culture</a>&rdquo; (June 10, 2013; coords. Anna Gibbs and Maria
			Angel)
		</li>
		<li>University of Cyprus: &ldquo;<a
		...
		<li>University of Rome La Sapienza: &ldquo;<a
			href="http://digilab2.let.uniroma1.it/teiconf2013/" target="new">The
				Linked TEI: Text Encoding in the Web</a>,&rdquo; organized by DIGILAB,
			Universit&agrave; La Sapienza, and Text Encoding Initiative
		...
		<li>Instituto Universit&aacute;rio da Maia, <span
			id="DeltaPlaceHolderMain">Centre for Research in Technologies
				and Intermedia Studies </span>(CITEI): Symposium &ldquo;Desafios e
			Oportunidades da Edi&ccedil;&atilde;o Digital&rdquo; (November 7,
			2013; coords. C&eacute;lia Vieira and Isabel Rio Novo)
		</li>
		<li>&Eacute;cole Normale Sup&eacute;rieure, Paris, Institut des
			...
			Van Hulle and Pierre Marc de Biasi)
		</li>
	</ul>
	...
	<ul>
		...
		<li>Calouste Gulbenkian Foundation: International conference
			&ldquo;<a href="http://estranharpessoa.com/programa" target="new">O
				Dia Triunfal de Fernando Pessoa</a>,&rdquo; organized by the Project
		...
		<li>University of Salamanca: Seminar Series &ldquo;Arc&aacute;dia
			Bab&eacute;lica&rdquo;, organized by the Philology Department of the
			University of Salamanca (June 20, 2014; coord. Pedro Serra)</li>
		<li>Northwestern University, Evanston, Illinois: International
			conference &ldquo;<a href="http://tei.northwestern.edu/" target="new">Decoding
				the Encoded</a>,&rdquo; organized by the Text Encoding Initiative
			Consortium (October 22-24, 2014; coord. Martin Mueller)
		</li>
	</ul>
	...
	<ul>
		...
		<li>University of Rome La Sapienza: Symposium &ldquo;<a
			...
			target="new">Edizioni Critiche Digitali: Edizioni a Confronto /
				Digital Critical Editions: Comparing Editions</a>,&rdquo; organized by
			the Dipartimento di Studi Greco-Latini, Italiani, Scenico-Musicali,
			Universit&aacute; la Sapienza, Roma (March 27, 2105; coords. Paola
			Italia and Claudia Bonsi)
		</li>
		<li>University of Georgia, Athens, GA, Wilson Center for
			Humanities and Arts: Symposium &ldquo;<a
		...
		<li>University of Coimbra, Centre for Portuguese Literature
			(CLP): International conference &ldquo;<a
			href="https://eld2015.wordpress.com/programme/" target="new">Digital
				Literary Studies | Estudos Liter&aacute;rios Digitais</a>&rdquo; (May
			14-15, 2015; coord. Manuel Portela)
		</li>
		<li>University of Lisbon, Institute for Scoial Sciences (ICS):
			Colloquium &ldquo;Cultura e Digital em Portugal em 2015&rdquo; (June
			17, 2015; coords. Jos&eacute; Lu&iacute;s Garcia, Jo&atilde;o
			Teixeira Lopes and Teresa Duarte Martinho)</li>
		<li>University of Gothemburg, Center for Digital Humanities: <a
			href="http://cdh.hum.gu.se/Aktuellt/e/?eventId=2355210788"
			target="new">Seminar</a> (September 24, 2015; coord. Jenny Bergenmar)
		</li>
		<li>New University of Lisbon, School of Social and Human Sciences
			(FCSH): International congress &ldquo;<a
			href="https://congressohdpt.wordpress.com/programa/" target="new">Humanidades
				...
				Digital</a>&rdquo; (October 8-9, 2015; coord. Daniel Alves)
		</li>
	...
	<ul>
		...
		<li>Rochester Institute of Technology, Rochester, NY, Digital
			...
			Lecture (April 19, 2016; coord. Sandy Baldwin)</li>
	...
	<ul>
		<li>University of Lisbon, School of Arts and Humanities: <a
			...
			(January 24, 2017; coords. Esperan&ccedil;a Cardeira, Cristina Sobral
			and Jo&atilde;o Dion&iacute;sio)
		</li>
		<li>University of California, Los Angeles, Graduate School of
			...
			href="https://is.gseis.ucla.edu/research/colloquium/" target="new">Colloquium:
				Breslauer lecture series</a> (February 2, 2017; coord. Johanna Drucker)
		</li>
		<li>Calouste Gulbenkian Foundation: <a
			...
			organizaed by Casa Fernando Pessoa (February 9-11, 2017; coord. Clara
			Riso)
		</li>
		<li>Fernando Pessoa University, Porto: International conference
			&ldquo;<a href="https://conference.eliterature.org/2017/conference"
		...
		<li>Complutense University of Madrid, School of Education:
			International Symposium of Digital Humanities of the South &ldquo;<a
			href="https://www.ucm.es/leethi/esc-programa" target="new">Escritura
				Creativa Digital y Colecciones Digitales</a>,&rdquo; organized by the
			research group LEETHI-Literaturas Espa&ntilde;olas y Europeas del
			Texto al Hipermedia (September 13-15, 2017; coord. Amelia Sanz)
		</li>
	</ul>
