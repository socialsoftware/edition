import { createVirtualEdition } from '@src/apiRequests';
import constants from '../../../constants';
import style from './createVeFormStyle.css?inline';

const onCreateVE = (e, node) => {
  e.preventDefault();
...
export default ({ node }) => {
  return (
    <form id="VEForm" onSubmit={(e) => onCreateVE(e, node)}>
      <style>{style}</style>
      <div class="form-row">
        <div class="form-col">
