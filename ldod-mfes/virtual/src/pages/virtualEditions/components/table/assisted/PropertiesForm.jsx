import style from './propertiesStyle.css?inline';
import { useProperties } from './AssistedTable';
import { setLinearVE } from '@src/apiRequests';
        ...
        {['heteronym', 'date', 'text', 'taxonomy'].map((prop) => (
          <div class=" text-center">
            ...
            <input
              ...
              step="0.2"
              value={`${
                parent.properties?.filter(({ type }) => prop === type)[0]
                  ?.weight || 0
              }`}
            />
          </div>
