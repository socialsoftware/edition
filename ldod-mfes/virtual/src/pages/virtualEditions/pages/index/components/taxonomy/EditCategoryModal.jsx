import { editCategory } from './taxonomyApiRequests';
...
export default ({ node, category }) => {
  ...
  return (
    <ldod-modal id="virtual-editCategoryModal" no-footer>
      <span slot="header-slot">
        <span>{node.getConstants('updateCategoryName')}</span>
      </span>
      <div slot="body-slot">
