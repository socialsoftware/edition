export default {
  ...
  pt: {
    ...
    generateTopicsInfo:
      'A Taxonomia gerada agrupa os fragmentos de acordo com os parâmetros',
    edition: 'Edição',
    topics: 'Tópicos',
    words: 'Palavras',
    cut: 'Corte',
    ...
    generateTopicsTitle:
      'Adição de categorias aplicando um algoritmo de geração de tópicos',
    actions: 'Accções',
    submit: 'Actualizar',
    name: 'Nome',
  ...
  en: {
    ...
    generateTopicsInfo:
      'The generated Taxonomy aggregates fragments according the parameters',
    edition: 'Edition',
    topics: 'Topics',
    words: 'Words',
    cut: 'Threshold',
  ...
  es: {
    ...
    generateTopicsTitle:
      'Añadir categorías aplicando un algoritmo de generación de tópicos',
    extractInfo:
