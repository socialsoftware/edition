...
export const getVirtualEditionByAcronym = async acrn => await fetcher.get(`${PATH}/acronym/${acrn}`, null);

export const getVeUser = async username => await fetcher.get(`${PATH}/user/${username}`, null);

export const getVeTaxonomy = async acronym => await fetcher.get(`${PATH}/acronym/${acronym}/taxonomy`, null);
