...
import VirtualIntersCompare from './components/virtual-inters-compare';
...
export class VirtualTranscription extends HTMLElement {
	...
	getIntersChecked = () => {
		return this.getRootNode().querySelector('virtual-frag-nav').intersChecked;
	};
	...
	async render() {
		...
		this.inters.length && this.wrapper.appendChild(<VirtualIntersCompare node={this} />);
	}
