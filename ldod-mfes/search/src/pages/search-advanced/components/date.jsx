export default class DateSelect extends HTMLElement {
      ...
      <>
        <div class="form-floating">
          <input
            ...
            type="number"
            name="beginDate"
            min={this.expertEdition.beginDate}
            max={this.expertEdition.endDate}
            onChange={this.onBeginDateChange}
            value={this.expertEdition.beginDate}
        ...
        <div class="form-floating">
          <input
            ...
            value={this.expertEdition.endDate}
            placeholder="endDate"
          />
  ...
  onEdition = () => {
    ...
    this.expertEdition = this.root.data.editions.find(
