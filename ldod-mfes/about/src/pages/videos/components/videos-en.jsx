export default () => {
  return (
    <>
      ...
      <ul>
        <li>
          <a href="#V1">Teaser_LdoD: LdoD Archive</a>
        </li>
        <li>
          <a href="#V2">Documentary reality is disorganized</a>
        </li>
        <li>
          <a href="#V3">Vicente Guedes and Bernardo Soares</a>
        </li>
        <li>
          <a href="#V4">Defining discursive units</a>
        </li>
        <li>
          <a href="#V5">Defining paragraphs</a>
        </li>
        <li>
          <a href="#V6">Human speech</a>
        </li>
        <li>
          <a href="#V7">Why editing?</a>
        </li>
        <li>
          <a href="#V8">Chronological organization</a>
        </li>
        <li>
          <a href="#V9">Heteronyms</a>
        </li>
        <li>
          <a href="#V10">Editing possibilities</a>
        </li>
        <li>
          <a href="#V11">Materiality and criticism</a>
        </li>
        <li>
          <a href="#V12">Spontaneous reading</a>
        </li>
        <li>
          <a href="#V13">Hyperconsciousness</a>
        </li>
        <li>
          <a href="#V14">LdoD Archive</a>
        </li>
        <li>
          <a href="#V15">Dynamic archive</a>
        </li>
        <li>
          <a href="#V16">Learning Researching Creating</a>
        </li>
        <li>
          <a href="#V17">Literary performativity simulator</a>
        </li>
      </ul>
