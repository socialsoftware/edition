export default () => {
  return (
    <>
      ...
      <ul>
        <li>
          <a href="#V1">Teaser_LdoD: Archivo LdoD</a>
        </li>
        <li>
          <a href="#V2">La realidad documental est&aacute; desorganizada</a>
        </li>
        <li>
          <a href="#V3">Vicente Guedes y Bernardo Soares</a>
        </li>
        <li>
          <a href="#V4">Creaci&oacute;n de unidades discursivas</a>
        </li>
        <li>
          <a href="#V5">Creaci&oacute;n de p&aacute;rrafos</a>
        </li>
        <li>
          <a href="#V6">Habla humana</a>
        </li>
        <li>
          <a href="#V7">&iquest;Por qu&eacute; editar?</a>
        </li>
        <li>
          <a href="#V8">Organizaci&oacute;n cronol&oacute;gica</a>
        </li>
        <li>
          <a href="#V9">Heter&oacute;nimos</a>
        </li>
        <li>
          <a href="#V10">Posibilidades de edici&oacute;n</a>
        </li>
        <li>
          <a href="#V11">Materialidad y cr&iacute;tica</a>
        </li>
        <li>
          <a href="#V12">Lectura espont&aacute;nea</a>
        </li>
        <li>
          <a href="#V13">Hiperconciencia</a>
        </li>
        <li>
          <a href="#V14">Archivo LdoD</a>
        </li>
        <li>
          <a href="#V15">Archivo din&aacute;mico</a>
        </li>
        <li>
          <a href="#V16">Aprender Investigar Crear</a>
        </li>
        <li>
          <a href="#V17">Simulador de performatividad literaria</a>
        </li>
      </ul>
