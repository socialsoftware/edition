...
const loadComponent = async lang => (await import(`./components/videos-${lang}.jsx`)).default();
...
!customElements.get('ldod-videos') && customElements.define('ldod-videos', LdodVideos);
