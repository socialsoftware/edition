  ...
  return (
    <>
      ...
      <p>
        ...
        by the Foundation for Science and Technology (FCT), and supported by the
        Centre for Portuguese Literature at the University of Coimbra (CLP), the{' '}
        <em>
          Instituto de Engenharia de Sistemas e Computadores, Investigação e
          Desenvolvimento em Lisboa
        </em>{' '}
        (INESC-ID), the National Library of Portugal (BNP), and the PhD
        Programme in Materialities of Literature (MATLIT).
      </p>
      <p>
        The <em>LdoD Archive</em> was developed under the research project “No
        Problem Has a Solution: A Digital Archive of the{' '}
        <em>Book of Disquiet</em>,” coordinated by Manuel Portela
        (PTDC/CLE-LLI/118713/2010). Project funded by the Foundation for Science
        and Technology (FCT), and co-funded by the European Regional Development
        Fund (FEDER), through Axis I of the Competitiveness Factors Operational
        Program (POFC) of the National Strategic Framework (QREN)—European Union
        (COMPETE: FCOMP-01-0124-FEDER-019715). Additional national funds by the
        Foundation for Science and Technology (FCT), under the “Plurianual
        Funding—Unit 759” projects: “PEst-OE/ELT/UI0759/2013” y
      ...
      <p>
        ...
        the collaboration of several individuals and institutions. Our gratitude
        is due, first and foremost, to the editors Jerónimo Pizarro, Richard
        Zenith, and Teresa Sobral Cunha, for consulting as specialists in the
        editorial problems of the <em>Book of Disquiet</em>. Our team of project
        consultants included three leading digital humanities scholars whose
        critical insight contributed to the advancement of our ideas: Johanna
        Drucker, Matthew G. Kirschenbaum, and Susan Schreibman have generously
        shared their expertise and provided continuing support and inspiration.
        We also want to thank Timothy Thompson for his contribution to the
        initial definition of the TEI schema. The <em>LdoD Archive</em> further
        acknowledges the collaboration of the Archives of Contemporary
        Portuguese Culture (National Library of Portugal), the Public Library
        and Regional Archive of Ponta Delgada (Regional Directorate for Culture
        of the Government of the Azores), and the Information and Communication
        Systems and Infrastructures Management Service (SGSIIC) at the
        University of Coimbra. We are also grateful to all beta users who, in
        September 2014 and May 2017, participated in usability tests of the
        functionalities and web design of the <em>LdoD Archive</em>.
      </p>
      <p>
        ...
        various conceptual and technical components of the <em>LdoD Archive</em>{' '}
        were presented, namely in universities and research centres in Portugal,
        Australia, Cyprus, Italy, France, Spain, Colombia, United States of
        America, Sweden, and Greece. The interaction with different communities
        of researchers (digital humanities, computer science, information
        science, textual encoding, textual criticism, Pessoa studies, electronic
        literature) is reflected in the final results. We highlight the
      ...
      <ul>
        ...
        <ul>
          <li>
            University of Coimbra, Centre for Portuguese Literature (CLP):
            Colloquium “Estranhar Pessoa com as Materialidades da Literatura”
            May 25, 2012; coords. Manuel Portela and Osvaldo Manuel Silvestre)
          </li>
        </ul>
        ...
        <ul>
          <li>
            New University of Lisbon, School of Social and Human Sciences
            (FCSH): VI Seminar “
            <a
            ...
            coords. António M. Feijó and Abel Barros Baptista)
          </li>
          <li>
            University of Western Sydney, School of Humanities and Communication
            Arts: Symposium “Surface Tensions: Literature in the Database”,
          ...
          <li>
            ...
            ” (September 21-25, 2013; coord. George Angelos Papadopoulos)
          </li>
          <li>
            ...
            ,” organized by DIGILAB, Università La Sapienza, and Text Encoding
            Initiative Consortium (October 2-5, 2013; coords. Fabio Ciotti and
            Arianna Ciula)
          </li>
          <li>
            Instituto Universitário da Maia,{' '}
            <span id="DeltaPlaceHolderMain">
              Centre for Research in Technologies and Intermedia Studies{' '}
            </span>
            (CITEI): Symposium “Desafios e Oportunidades da Edição Digital”
            (November 7, 2013; coords. Célia Vieira and Isabel Rio Novo)
          </li>
          <li>
            ...
            (November 22-24, 2013; coords. Dirk Van Hulle and Pierre Marc de
            Biasi)
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            Calouste Gulbenkian Foundation: International conference “
            <a href="http://estranharpessoa.com/programa" target="new">
              O Dia Triunfal de Fernando Pessoa
            </a>
            ,” organized by the Project “Estranhar Pessoa,” Laboratory of
            Advanced Literary Studies (ELAB), Network of Philosophy and
            Literature, Institute of Philosophy of Language (IFL) and Program in
            Theory of Literature (March 6-8, 2014; coords. António M. Feijó and
          ...
          <li>
            ...
            and Biblioteca Luis Ángel Arango (May 6-8, 2014; coord. Jerónimo
            Pizarro)
          </li>
          <li>
            University of Salamanca: Seminar Series “Arcádia Babélica”,
            organized by the Philology Department of the University of Salamanca
            (June 20, 2014; coord. Pedro Serra)
          </li>
          <li>
            Northwestern University, Evanston, Illinois: International
            conference “
            <a href="http://tei.northwestern.edu/" target="new">
              Decoding the Encoded
            </a>
            ,” organized by the Text Encoding Initiative Consortium (October
            22-24, 2014; coord. Martin Mueller)
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            Sciences de l’Homme and Université de Grenoble (January 26, 2015;
            coords. Matthew Driscol and Elena Pierazzo)
          </li>
          <li>
            ...
            ,” organized by the Dipartimento di Studi Greco-Latini, Italiani,
            Scenico-Musicali, Universitá la Sapienza, Roma (March 27, 2105;
            coords. Paola Italia and Claudia Bonsi)
          </li>
          <li>
            University of Georgia, Athens, GA, Wilson Center for Humanities and
            Arts: Symposium “
            <a
          ...
          <li>
            ...
            ” (May 14-15, 2015; coord. Manuel Portela)
          </li>
          <li>
            University of Lisbon, Institute for Scoial Sciences (ICS):
            Colloquium “Cultura e Digital em Portugal em 2015” (June 17, 2015;
            coords. José Luís Garcia, João Teixeira Lopes and Teresa Duarte
            Martinho)
          </li>
          <li>
          ...
          <li>
            ...
            ” (October 8-9, 2015; coord. Daniel Alves)
          </li>
          <li>
            University of Coimbra, Centre for Social and Cultural History
          ...
          <li>
            ...
            ,” organized by the “Art, Culture and Communication” Section of the
            Portuguese Association of Sociology (November 26, 2015; coords.
            Claudino Ferreira and Paula Abreu)
          </li>
        </ul>
        <h4>2016</h4>
        <ul>
          <li>
            Aristotle University of Thessaloniki, Department of American
            Studies: Seminar (January 28, 2016; coord. Tatiani Raptzikou)
          </li>
          <li>
            University of Maryland, College Park, Maryland Institute for
            Technology in the Humanities (MITH): Research seminar (March 29,
            2016; coord. Neil Fraistat)
          </li>
          <li>
            University of Maryland, College Park, English Department, Center for
            Comparative and Literary Studies (CCLS):{' '}
            <a href="http://www.english.umd.edu/events/23271" target="new">
              Research Talk
            </a>{' '}
            (April 14, 2016; coord. Orrin Wang)
          </li>
          <li>
            Rochester Institute of Technology, Rochester, NY, Digital Humanities
            and Social Sciences Program and School of Media Sciences: Lecture
            (April 19, 2016; coord. Sandy Baldwin)
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Complutense University of Madrid, School of Education: International
            Symposium of Digital Humanities of the South “
            <a href="https://www.ucm.es/leethi/esc-programa" target="new">
              Escritura Creativa Digital y Colecciones Digitales
            </a>
            ,” organized by the research group LEETHI-Literaturas Españolas y
            Europeas del Texto al Hipermedia (September 13-15, 2017; coord.
            Amelia Sanz)
          </li>
        </ul>
      </ul>
