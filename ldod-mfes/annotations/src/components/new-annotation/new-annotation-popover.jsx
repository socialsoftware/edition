...
export class NewAnnPopover extends HTMLElement {
	...
	handleNewAnnotation = async e => {
		...
		if (selection.type !== 'Range' || selection.isCollapsed) return this.hidePopover();
...
!customElements.get('new-ann-popover') && customElements.define('new-ann-popover', NewAnnPopover);
