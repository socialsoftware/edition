...
export default ({ posY }) => {
  ...
  return (
    <>
      ...
      <p>
        {' '}
        The Centre for Portuguese Literature at the University of Coimbra (“us”,
        “we”, or “our”) operates{' '}
        <a href="https://ldod.uc.pt">https://ldod.uc.pt</a> (the “Site”). This
      ...
      <p>
        ...
        that collect, monitor and analyze the patterns of access and use of the
        Site.
      </p>
      <p>&nbsp;</p>
      <h4>Cookies</h4>
      ...
      <p>
        ...
        electronic storage, is 100% secure. While we strive to use available
      ...
      <p>
        This Privacy Policy is effective as of February 2018 and will remain in
      ...
      <p>
        ...
        use of the Site after we post any modifications to the Privacy Policy on
