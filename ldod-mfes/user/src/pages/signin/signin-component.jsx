...
class SignIn extends HTMLElement {
	...
	async updateLanguage() {
		...
		['[data-key]'].forEach(selector =>
			this.querySelectorAll(selector).forEach(ele => (ele.textContent = this.getConstants(ele.dataset.key)))
		);
	...
	clearStyleInputs() {
		this.querySelectorAll('.valid').forEach(div => div.classList.remove('valid'));
	}
