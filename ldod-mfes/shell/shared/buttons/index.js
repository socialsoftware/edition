...
import { exportButton, uploadButton, ldodButton } from './buttons';
exportButton();
uploadButton();
ldodButton();
...
exportFrags.dataset.url = 'http://localhost:8000/api/text/admin/export-fragments';
...
window.addEventListener('ldod-message', ({ detail }) => console.log(detail.message));
