lighthouse http://localhost:9000/ldod-mfes/  --only-categories performance --preset=desktop --output=json --output-path=report/report_mfe.json --view --screenEmulation.disabled

lighthouse http://localhost:8000  --only-categories performance --preset=desktop --output=json --output-path=report/report_mono.json --view --screenEmulation.disabled 
#
