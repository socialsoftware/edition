...
import ExpertEditionTable from './components/ExpertEditionTable';
...
export class LdodEditionAcrn extends HTMLElement {
  ...
  render() {
    ...
    this.wrapper.appendChild(
      <>
        <Title
          args={JSON.stringify(titleArgs)}
          title={this.getConstants('edition', titleArgs)}
          key="edition"
        />
...
!customElements.get('ldod-edition-acrn') &&
  customElements.define('ldod-edition-acrn', LdodEditionAcrn);
