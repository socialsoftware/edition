				...
				<c:when test="${pageContext.request.userPrincipal.authenticated}">
					<li class="dropdown login logged-in">
						...
						<ul class="dropdown-menu">
							...
							<!--Profile-->
							<li><a href="<c:url value="${contextPath}/user/profile/${pageContext.request.userPrincipal.principal.getUser().getUsername()}"/>"><spring:message code="header.profile" /></a></li>
							<!--Achievements-->
							<li><a href="<c:url value="${contextPath}/user/profile/${pageContext.request.userPrincipal.principal.getUser().getUsername()}/achievements"/>"><spring:message code="header.achievements" /></a></li>
		...
		<ul class="nav navbar-nav navbar-nav-flex">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="${contextPath}/about/privacy"><spring:message code="header.privacy" /></a></li>
					<li><a href="${contextPath}/about/team"><spring:message code="header.team" /></a></li>
					<li><a href="${contextPath}/about/acknowledgements"><spring:message code="header.acknowledgements" /></a></li>
					<li><a href="${contextPath}/about/contact"><spring:message code="header.contact" /></a></li>
