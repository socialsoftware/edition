...
import pt.ist.socialsoftware.edition.core.domain.Member.MemberRole;
...
import pt.ist.socialsoftware.edition.core.dto.EditionTranscriptionsDTO;
...
import pt.ist.socialsoftware.edition.core.dto.TranscriptionDTO;
...
import pt.ist.socialsoftware.edition.core.shared.exception.LdoDDuplicateAcronymException;
import pt.ist.socialsoftware.edition.core.shared.exception.LdoDDuplicateNameException;
import pt.ist.socialsoftware.edition.core.shared.exception.LdoDEditVirtualEditionException;
import pt.ist.socialsoftware.edition.core.shared.exception.LdoDException;
import pt.ist.socialsoftware.edition.core.shared.exception.LdoDExceptionNonAuthorized;
...
public class VirtualEditionController {
  ...
  public String showEditVirtualEdition(Model model, @PathVariable String externalId) {
    ...
    logger.debug(
        "showEditVirtualEditionn externalId:{}, acronym:{}, title:{}, pub:{}, fraginters.size:{}",
  ...
  public String editVirtualEdition(Model model,
      @ModelAttribute("ldoDSession") LdoDSession ldoDSession, @PathVariable String externalId,
      @RequestParam("acronym") String acronym, @RequestParam("title") String title,
      @RequestParam("synopsis") String synopsis, @RequestParam("pub") boolean pub,
      @RequestParam("management") boolean management,
      @RequestParam("vocabulary") boolean vocabulary,
    ...
    try {
      virtualEdition.edit(VirtualEdition.ACRONYM_PREFIX + acronym, title, synopsis, pub, management,
  ...
  @PreAuthorize("hasPermission(#externalId, 'virtualedition.participant')")
  public String reorderVirtualEdition(Model model,
      @ModelAttribute("ldoDSession") LdoDSession ldoDSession, @PathVariable String externalId,
  ...
  public @ResponseBody ResponseEntity<EditionFragmentsDTO> getFragments(Model model,
  ...
  public String submitParticipation(Model model,
      @ModelAttribute("ldoDSession") LdoDSession ldoDSession, @PathVariable String externalId) {
    VirtualEdition virtualEdition = FenixFramework.getDomainObject(externalId);
    LdoDUser user = LdoDUser.getAuthenticatedUser();
  ...
  public String cancelParticipationSubmission(Model model,
      @ModelAttribute("ldoDSession") LdoDSession ldoDSession, @PathVariable String externalId) {
    VirtualEdition virtualEdition = FenixFramework.getDomainObject(externalId);
    LdoDUser user = LdoDUser.getAuthenticatedUser();
  ...
  @PreAuthorize("hasPermission(#externalId, 'virtualedition.admin')")
  public String addParticipant(RedirectAttributes redirectAttributes,
      @PathVariable("externalId") String externalId, @RequestParam("username") String username) {
  ...
  public String editTaxonomy(Model model, @PathVariable("externalId") String externalId,
      ...
      @RequestParam("vocabulary") boolean vocabulary,
      @RequestParam("annotation") boolean annotation) {
    logger.debug("editTaxonomy externalId:{}, management:{}, vocabulary:{}, annotation:{}",
        externalId, management, vocabulary, annotation);
  ...
  public String generateTopicModelling(Model model,
      @ModelAttribute("ldoDSession") LdoDSession ldoDSession, @PathVariable String externalId,
    ...
    if (virtualEdition == null) {
      ...
      LdoDUserDetails userDetails = (LdoDUserDetails) SecurityContextHolder.getContext()
  ...
  @PreAuthorize("hasPermission(#externalId, 'virtualedition.taxonomy')")
  public String createTopicModelling(Model model,
      @ModelAttribute("ldoDSession") LdoDSession ldoDSession, @PathVariable String externalId,
      @ModelAttribute("topicList") TopicListDTO topicList) throws IOException {
    logger.debug("createTopicModelling externalId:{}, username:{}", externalId,
        topicList.getUsername());
  ...
  public String mergeCategories(Model model, @RequestParam("taxonomyId") String taxonomyId,
    ...
    if (categoriesIds == null) {
      return "redirect:/virtualeditions/restricted/" + taxonomy.getEdition().getExternalId()
          + "/taxonomy";
    }
  ...
  public String dissociate(Model model, @PathVariable String fragInterId,
  ...
  public String associateCategory(Model model, @RequestParam("fragInterId") String fragInterId,
    ...
    if ((categories != null) && (categories.length > 0)) {
      inter.associate(LdoDUser.getAuthenticatedUser(),
