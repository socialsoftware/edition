...
//        writer.write();
        String transcription = textProvidesInterface.getWriteFromPlainTextFragmentWriter(sourceInter.getXmlId());
...
//            writer.write();
            String transcription = textProvidesInterface.getWriteFromPlainTextFragmentWriter(interDto.getXmlId());
