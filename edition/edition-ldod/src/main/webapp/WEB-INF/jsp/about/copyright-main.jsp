		...
		<div class="col-md-8 col-md-offset-2 ldod-about">
			...
			<c:choose>
				<c:when
					...
					<%@ include file="/WEB-INF/jsp/about/copyright-en.jsp"%>
				</c:when>
				<c:when
					test='${pageContext.response.locale.getLanguage().equals("es")}'>
					<%@ include file="/WEB-INF/jsp/about/copyright-es.jsp"%>
				</c:when>
				<c:otherwise><%@ include file="/WEB-INF/jsp/about/copyright-pt.jsp"%></c:otherwise>
			</c:choose>
		</div>
