...
//        this.mockMvc.perform(get("/visual/editions/acronym/{acronym}/fragments", feTextRequiresInterface.getExpertEditionByAcronym(CUNHA_EDITION_ACRONYM).getAcronym()))
//                .andDo(print()).andExpect(status().isOk()).andExpect(content().string(notNullValue()));
//    }
//
//    @Test
...
//        ScholarInterDto expertEditionInter = new FeSearchRequiresInterface().getExpertEditionScholarInterDtoList(ZENITH_EDITION_ACRONYM).get(0);
//
//
