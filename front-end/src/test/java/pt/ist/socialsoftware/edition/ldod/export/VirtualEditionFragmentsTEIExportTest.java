...
//                        "country", "username", "profURL", "profImgURL");
                new TwitterCitation(new FragmentDto(fragment), "sourceLink", "date", "fragText", "tweetText", 7777l, "location",
                        "country", "username", "profURL", "profImgURL");
...
//                        "location", "country", "username", "profURL", "profImgURL");
                TwitterCitation tc = new TwitterCitation(new FragmentDto(fragment), "sourceLink", "date", "fragText", "tweetText", 7777l,
                        "location", "country", "username", "profURL", "profImgURL");
