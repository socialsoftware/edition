                    ...
                    <form class="form-inline" method="POST"
                        ...
                        <div class="form-group">
                            <select class="form-control tip" name="use"
                                    title="<spring:message code="virtualedition.tt.use" />">
                                <option
                            ...
                            <tr>
                                <td class="text-center"><c:if test="${!isLdoDEdition}">
                                    <form class="form-inline" method="POST"
                                        ...
                                        <c:choose>
                                        <c:when
                                                test="${frontendSession.hasSelectedVE(virtualEdition.acronym)}">
                                               checked
                                        </c:when>
                                        </c:choose>>
                                        <!--
                                ...
                                <td><a href="/edition/acronym/${virtualEdition.acronym}">${virtualEdition.title}</a>
                                </td>
