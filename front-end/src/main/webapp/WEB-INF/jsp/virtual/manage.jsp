                ...
                <div class="well" style="height: 500px">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4" style="padding-left: 0px">
                            ...
                            <c:choose>
                                <c:when
                                        test="${virtualEdition.taxonomy.isOpenManagement() == true}">
                        ...
                        <div class="form-group  col-md-4" style="padding-left: 0px">
                            ...
                            <c:choose>
                                <c:when
                                        test="${virtualEdition.taxonomy.isOpenAnnotation() == true}">
                                    <option value="true" selected>
                        ...
                        <div class="form-group  col-md-3" style="padding-left: 0px">
                            ...
                            <c:choose>
                                <c:when
                                        test="${virtualEdition.taxonomy.isOpenVocabulary() == true}">
                                    <option value="true" selected>
                    ...
                    <div class="row">
                        <div class="form-group  col-md-4" style="padding-left: 0px">
                            ...
                            <c:choose>
                                <c:when
                                        test="${virtualEdition.getMediaSourceName() == 'Twitter'}">
                        ...
                        <div class="form-group  col-md-4" style="padding-left: 0px">
                            ...
                            <input type="date" value="${virtualEdition.getTimeWindowBeginDate()}"
                        ...
                        <div class="form-group  col-md-4" style="padding-left: 0px">
                            ...
                            <input type="date" value="${virtualEdition.getTimeWindowEndDate()}"
                    ...
                    <div class="row">
                        <div class="form-group col-md-2" style="padding-left: 0px">
                            ...
                            <!-- selects all boxes -->
                            <c:choose>
                                <c:when test="${virtualEdition.containsEveryCountryinGeographicLocation()}">
                            ...
                            <c:forEach var='country' items='${countriesList}'>
                                <c:choose>
                                    <c:when test="${virtualEdition.containsCountryinGeographicLocation(country)}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-2" style="padding-left: 0px">
                            ...
                            <input type="number" min="1" value="${virtualEdition.getIntegerFrequency()}"
            ...
            <table class="table table-hover">
                ...
                <c:if test="${(isPublic && !isLdoDEdition) || isMember}">
                    <tr>
                        ...
                        <td class="text-center"><c:if test="${isMember}">
                            <a
                                    href="${contextPath}/recommendation/restricted/${virtualEdition.acronym}"><span
