...
<div class="container">
    ...
    <div class="row col-md-1">
        <form class="form-inline" method="GET"
              action="${contextPath}/virtualeditions/restricted/manage/${fragInter.getVirtualEditionDto().getExternalId()}">
    ...
    <div class="col-md-12">
        <h3 class="text-center">
            ${fragInter.getVirtualEditionDto().getTitle()} - <a
                href="${contextPath}/virtualeditions/restricted/${fragInter.getVirtualEditionDto().getExternalId()}/taxonomy"><spring:message
        ...
        <div class="row pull-right" align="center">
				<span class="bg-info" style="padding: 8px"> <spring:message
                        ...
                        href="${contextPath}/edition/acronym/${fragInter.getVirtualEditionDto().getAcronym()}">
						<span class="glyphicon glyphicon-list-alt"></span> <spring:message
                        code="general.edition"/>
				</a> - <a
                        href="${contextPath}/fragments/fragment/${fragInter.getFragmentXmlId()}/inter/${fragInter.getUrlId()}">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    <td><c:forEach var="category"
                                   items='${fragInter.getSortedCategories(fragInter.getVirtualEditionDto())}'>
                        <a
