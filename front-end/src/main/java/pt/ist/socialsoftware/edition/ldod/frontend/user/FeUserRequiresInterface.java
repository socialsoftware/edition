...
import pt.ist.socialsoftware.edition.notification.dtos.user.RegistrationTokenDto;
import pt.ist.socialsoftware.edition.notification.dtos.user.UserConnectionDto;
