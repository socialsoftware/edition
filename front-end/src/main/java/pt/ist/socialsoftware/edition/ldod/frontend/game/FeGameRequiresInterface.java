...
import pt.ist.socialsoftware.edition.notification.dtos.game.ClassificationGameDto;
import pt.ist.socialsoftware.edition.notification.dtos.game.PlayerDto;
import pt.ist.socialsoftware.edition.notification.dtos.game.wrapper.CreateGameWrapper;
...
//    private final UserProvidesInterface userProvidesInterface = new UserProvidesInterface();
    ...
    public void createClassificationGame(VirtualEditionDto virtualEdition, String description, DateTime parse, VirtualEditionInterDto inter, String authenticatedUser) {
        webClientGame.build()
                ...
                .bodyValue(new CreateGameWrapper(virtualEdition, description, parse, inter, authenticatedUser))
                .retrieve()
