...
//import static pt.ist.socialsoftware.edition.text.domain.ExpertEdition.*;
...
public class FragmentController {
    ...
    public String getFragmentWithInter(Model model, @PathVariable String externalId) {
        ...
        if (inter == null) {
            return "redirect:/error";
        } else if (this.feTextRequiresInterface.isDomainObjectScholarInter(externalId)) {
...
//            HtmlWriter2CompInters writer = new HtmlWriter2CompInters(scholarInters);
            ...
            List<String> apps = this.feTextRequiresInterface.putAppTextWithVariations(externalId, scholarInters);
