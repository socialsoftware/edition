...
public class EditionController {
    ...
    public String getEditionTableOfContentsbyAcronym(Model model, @PathVariable String acronym) {
       // ExpertEdition expertEdition = TextModule.getInstance().getExpertEdition(acronym);
        ExpertEditionDto expertEdition = this.textProvidesInterface.getExpertEditionDto(acronym);
    ...
    public String getEditionTableOfContentsbyId(Model model, @PathVariable String externalId) {
        ...
        if (edition == null) {
            ...
            String acronym = (this.textProvidesInterface.isDomainObjectScholarEdition(externalId)) ? this.textProvidesInterface.getScholarEditionAcronymbyExternal(externalId)
                    : this.virtualProvidesInterface.getVirtualEditionByExternalId(externalId).getAcronym();
    ...
    public String getEditionTableOfContents4Heteronym(Model model, @PathVariable String id1, @PathVariable String id2) {
        ...
        ExpertEditionDto edition = this.textProvidesInterface.getExpertEditionByExternalId(id1);
        HeteronymDto heteronym = this.textProvidesInterface.getHeteronymByExternalId(id2);
