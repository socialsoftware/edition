...
class ConnectedPublicEditionContainer extends React.Component {
    ...
    render() {
                    ...
                    return (<div className="card">
                        ...
                        <div className="container">
                            ...
                            <div className="welcomeButton">
                                ...
                                <Button bsStyle={buttonStyle} bsSize="small"
        ...
        return <div>
            ...
            <p align="center">Aqui poderá escolher, ler e explorar uma das edições dos peritos ou edições virtuais
                públicas do {" "}
            ...
            <p align="center">Poderá criar a sua própria edição virtual e consultar detalhes de outras edições virtuais
                públicas {' '}
                <a href="https://ldod.uc.pt/virtualeditions">
                    nesta secção do Arquivo LdoD</a>.
            </p>
            <p align="center">
                Apenas se selecionar uma edição com categorias disponíveis (taxonomia), poderá realizar atividades à
                volta das mesmas.</p>
