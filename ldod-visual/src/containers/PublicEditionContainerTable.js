...
class ConnectedPublicEditionContainerTable extends React.Component {
    ...
    render() {
        ...
        if (this.state.editionsReceived) {
            ...
            this.state.editions.map(item => {
                ...
                if (item.type == "perito" && this.expertEditionArray.length < 4) {
                    ...
                    let expertObj = {
                        ...
                        navButton: (
                            <Button bsStyle="default" bsSize="small" onClick={() => this.handleButtonClick(item)}>
                                Selecionar edição
                            </Button>)
                    };
                    ...
                    let obj = {
                        ...
                        navButton: (<Button block="block" bsStyle={buttonStyle} bsSize="small"
            ...
            editionButtonList = (
                <div><img src={loadingGif} alt="loading...publiceditiontable" className="loadingGifCentered"/>
        ...
        return <div>
            ...
            <p align="center">
                Alternativamente a uma edição virtual, pode escolher uma das edições dos peritos, cuja leitura e
                interação no LdoD Visual serão semelhantes às de uma edição virtual.
            </p>
            <p align="center">
                Relembramos que as edições dos peritos não têm categorias disponíveis (taxonomia).
            </p>
            <p align="center">
                Apenas se selecionar uma edição com categorias disponíveis, poderá realizar atividades à volta das
                mesmas.
            </p>
            ...
            <div className="mySlider">
                ...
                <Slider min={0} max={maxNumberOfInters} value={sliderNum} tooltip={false} orientation="horizontal"
                        onChange={this.handleOnChange} labels={labelsObj}/>
