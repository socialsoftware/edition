...
const mapDispatchToProps = dispatch => {
  return {
    setCurrentVisualization: currentVisualization =>
      dispatch(setCurrentVisualization(currentVisualization))
  };
};
...
class ConnectedNetworkGraphContainer extends Component {
  ...
  componentDidMount() {
    ...
    service
      .getIntersByDistance(
        this.props.pFragmentId,
        this.props.pHeteronymWeight,
        this.props.pTextWeight,
        this.props.pDateWeight,
        this.props.ptaxonomyWeight
      )
      .then(response => {
  ...
  render() {
    ...
    if (this.state.fragmentsDistanceLoaded) {
      graphToRender = (
        <NetworkGraph
          graphData={this.state.networkGraphData}
          onChange={this.props.onChange}
        />
      );
    } else {
...
const NetworkGraphContainer = connect(
  mapStateToProps,
  mapDispatchToProps
)(ConnectedNetworkGraphContainer);
