...
public class ExpertEdition extends ExpertEdition_Base implements Comparable<ExpertEdition> {
	public ExpertEdition(CollectionManager collectionManager, String title, String author, String editor, LocalDate date) {
		setTitle(title);
		setAuthor(author);
		setEditor(editor);
		setDate(date);
		...
		setCollectionManager4Expert(collectionManager);
	}
