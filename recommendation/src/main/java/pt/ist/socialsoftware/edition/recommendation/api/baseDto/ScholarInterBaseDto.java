...
import pt.ist.socialsoftware.edition.recommendation.api.textDto.FragScholarInterDto;


public class ScholarInterBaseDto {

    private static final Logger logger = LoggerFactory.getLogger(ScholarInterBaseDto.class);
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        ScholarInterBaseDto other = (ScholarInterBaseDto) o;
