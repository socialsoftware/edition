...
public class ReactUiController {
    ...
    public ResponseEntity<?> getCategoriesForInter(@RequestParam String id) {
        ...
        List<CategoryDTO> categories = inter.getAllDepthCategoriesAccessibleByUser(this.feUserProvidesInterface.getAuthenticatedUser()).stream()
    ...
    public ResponseEntity<?> createAnnotation(@RequestBody AnnotationDTO annotationJson) {
        ...
        if (HumanAnnotation.canCreate(virtualEdition, username)) {
    ...
    public ResponseEntity<?> updateAnnotation(@PathVariable String id, @RequestBody AnnotationDTO annotationJson) {
        ...
        if (annotation.canUpdate(this.feUserProvidesInterface.getAuthenticatedUser())) {
    ...
    public AnnotationSearchJson searchAnnotations(@RequestParam String uri) {
        ...
        for (Annotation annotation : inter.getAllDepthAnnotationsAccessibleByUser(this.feUserProvidesInterface.getAuthenticatedUser())) {
