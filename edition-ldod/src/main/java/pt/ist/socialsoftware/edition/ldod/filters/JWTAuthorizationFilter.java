...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
	...
	private final static String TOKEN_PREFIX = PropertiesManager.getProperties().getProperty("spring.security.jwt.token.prefix");
	private final static String HEADER_STRING = PropertiesManager.getProperties().getProperty("spring.security.jwt.header.string");
