...
public class LoadTEIFragments {
    ...
    public void loadFragmentsStepByStep(InputStream file, List<UploadFragmentDto> uploadFrags) throws LdoDLoadException {
