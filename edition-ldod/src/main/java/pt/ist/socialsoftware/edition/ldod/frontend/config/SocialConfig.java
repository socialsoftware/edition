...
import pt.ist.socialsoftware.edition.ldod.frontend.user.security.UserModuleUsersConnectionRepository;
...
public class SocialConfig extends SocialConfigurerAdapter {
    ...
    public UsersConnectionRepository getUsersConnectionRepository(ConnectionFactoryLocator connectionFactoryLocator) {
        ...
        return new UserModuleUsersConnectionRepository(connectionFactoryLocator, this.textEncryptor);
    }
    ...
    public ProviderSignInController providerSignInController(ConnectionFactoryLocator connectionFactoryLocator,
        ...
        return new ProviderSignInController(connectionFactoryLocator, usersConnectionRepository,
                new UserModuleSignInAdapter(new HttpSessionRequestCache()));
    }
