    ...
    <div class="row reading-grid">
        ...
        <div class="reading__column--open col-xs-12 col-sm-1 no-pad">
                    ...
                    <c:otherwise>
                        ...
                        <c:forEach var="expertEditionInter"
                            ...
                            <div class="hidden-xs" style="margin-bottom:25px">
                                <a
                                        href="${contextPath}/reading/fragment/${fragment.xmlId}/inter/${expertEditionInter.urlId}">
                                    <!--${expertEditionInter.getExpertEdition().getAcronym()}-->
            ...
            <div class="reading__column col-xs-12 col-sm-1 no-pad recommendation-line">
                <h4 class="f--condensed"><a href="#" class="f--condensed--link"
                                            onClick="openRecomModal()"><spring:message
                            ...
                            <c:if test="${prevRecom != null}">
                                <div class="h3-div">
                                    <a href="${contextPath}/reading/inter/prev/recom">
                                        <h3>${prevRecom.getExpertEdition().getAcronym()}</h3>
              ...
              <img src="/resources/img/graphics/arrow_left.png">
                        ...
                        <c:forEach var="recomInter" items="${recommendations}">
                            <div>
                                <a href="${contextPath}/reading/fragment/${recomInter.fragmentXmlId}/inter/${recomInter.urlId}">
                                    <!--<span class="glyphicon glyphicon-forward"></span>-->
                                    <h3>${recomInter.getExpertEdition().getAcronym()}</h3>
