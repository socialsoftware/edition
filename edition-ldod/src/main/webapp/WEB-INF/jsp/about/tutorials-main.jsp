...
<div class="container">
    <div class="col-md-8 col-md-offset-2 ldod-about">
        <h1 class="text-center">
            <spring:message code="header.tutorials"/>
        </h1>
        <p>&nbsp;</p>
        <c:choose>
            <c:when
                    test='${pageContext.response.locale.getLanguage().equals("en")}'>
                <%@ include file="/WEB-INF/jsp/about/tutorials-en.jsp" %>
            </c:when>
            <c:when
                    test='${pageContext.response.locale.getLanguage().equals("es")}'>
                <%@ include file="/WEB-INF/jsp/about/tutorials-es.jsp" %>
            </c:when>
            <c:otherwise>
                <%@ include file="/WEB-INF/jsp/about/tutorials-pt.jsp" %>
            </c:otherwise>
        </c:choose>
    </div>
            ...
            <p>
                ...
                <c:choose>
                    ...
                    <c:when test="${pageContext.response.locale.language.equalsIgnoreCase('es')}">
                        ...
                        marco de los proyectos de &ldquo;Financiaci&oacute;n Plurianual&mdash;Unidad 759&rdquo;: PEst-OE/ELT/UI00759/2013, PEst-OE/ELT/UI0759/2014, UIDB/00759/2020 y UIDP/00759/2020.
                    </c:when>
                </c:choose>
