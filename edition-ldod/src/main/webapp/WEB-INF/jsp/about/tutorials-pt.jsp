<h4>
	<ul>
		<li><a href="#Q01Q">A. Tutoriais</a></li>
		<li><a href="#Q02Q">B. Oficinas</a></li>
...
<p>
  Os Tutoriais LdoD t&ecirc;m duas fun&ccedil;&otilde;es principais: (1) apresentar didaticamente a estrutura da plataforma;  
  (2) familiarizar os utilizadores com as m&uacute;ltiplas funcionalidades dessa estrutura. Os v&iacute;deos introduzem, 
...
<ul>
	<li><a href="#V1">Tutorial 1: O que &eacute; o <em>Arquivo LdoD</em>?</a></li>
	<li><a href="#V2">Tutorial 2: Conhecendo o <em>Arquivo LdoD</em></a></li>
	<li><a href="#V3">Tutorial 3: Leitura</a></li>
	<li><a href="#V4">Tutorial 4: Documentos</a></li>
	<li><a href="#V5">Tutorial 5: Edi&ccedil;&otilde;es</a></li>
	<li><a href="#V6">Tutorial 6: Pesquisa</a></li>
	<li><a href="#V7">Tutorial 7: O que &eacute; a Edi&ccedil;&atilde;o Virtual?</a></li>
	<li><a href="#V8">Tutorial 8: Planejando edi&ccedil;&otilde;es virtuais</a></li>
	<li><a href="#V9">Tutorial 9: Criando edi&ccedil;&otilde;es virtuais</a></li>
	<li><a href="#V10">Tutorial 10: Taxonomia e anota&ccedil;&otilde;es</a></li>
</ul>


<br />
<h5 id="V1">Tutorial 1: O que &eacute; o <em>Arquivo LdoD</em>?</h5>
...
<h5 id="V2">Tutorial 2: Conhecendo o <em>Arquivo LdoD</em></h5>
...
<h5 id="V3">Tutorial 3: Leitura</h5>
...
<h5 id="V5">Tutorial 5: Edi&ccedil;&otilde;es</h5>
<div class="videoWrapper">
<iframe width="560" height="315"
...
<h5 id="V7">Tutorial 7: O que &eacute; a Edi&ccedil;&atilde;o Virtual?</h5>
<div class="videoWrapper">
<iframe width="560" height="315"
...
<p>
	O <em>Arquivo LdoD</em> oferece v&aacute;rias oficinas a quem estiver interessado em aprender mais sobre a plataforma e os seus usos. Estas oficinas t&ecirc;m 
	tr&ecirc;s objetivos principais: (1) proporcionar uma explora&ccedil;&atilde;o pr&aacute;tica orientada de todas as funcionalidades do <em>Arquivo LdoD</em> (leitura, edi&ccedil;&atilde;o, escrita);
   	(2) ajudar os interessados a adaptar os usos da plataforma aos seus objetivos pessoais ou institucionais (incluindo o ensino em contextos formais e informais,
     	estudo e an&aacute;lise, investiga&ccedil;&atilde;o avan&ccedil;ada, escrita criativa e performance ao vivo); (3) obter feedback de diferentes tipos de utilizador que nos ajude a melhorar a
	usabilidade do <em>Arquivo LdoD</em>. As Oficinas LdoD est&atilde;o dispon&iacute;veis em sess&otilde;es presenciais ou em linha.
</p>
...
<p><strong>2019</strong> </p>
	...
	<p>Cec&iacute;lia Magalh&atilde;es, &ldquo;Fragmentos em Pr&aacute;tica: colabora&ccedil;&atilde;o e criatividade no Arquivo do <em>Livro do Desassossego</em>&rdquo; 
		(videoconfer&ecirc;ncia), I STAD (Semin&aacute;rio de Trabalhos Acad&ecirc;micos em Desenvolvimento) e 
...
<p><strong>2020</strong> </p>
	...
	<p> Cec&iacute;lia Magalh&atilde;es, 17/02/2020. &ldquo;Pr&aacute;ticas Criativas no Arquivo do <em>Livro do Desassossego</em>&rdquo;(3 horas). 
		Semin&eacute;rio ministrado na a&ccedil;&atilde;o de forma&ccedil;&atilde;o &ldquo;Pr&aacute;ticas criativas e inovadoras 
		no ensino da literatura&rdquo; (CCPFC/ACC-106241/19 - 18 horas). Faculdade de Letras da Universidade de Coimbra (FLUC).</p>
	...
	<p>Cec&iacute;lia Magalh&atilde;es e Liliana Vasques, &ldquo;Sess&otilde;es Online Arquivo LdoD: 3. Oficina LdoD Remix&rdquo;, 27/05/2020, 20h00-21h30.</p> 
