...
<div class="container">
    <div class="col-md-8 col-md-offset-2 ldod-about">
        <h1 class="text-center">
            <spring:message code="header.book" />
        </h1>
        <p>&nbsp;</p>
        <img class="center" src="/resources/img/LiterarySimulation_BookCover.jpeg" width="75%">
        <c:choose>
            <c:when
                    test='${pageContext.response.locale.getLanguage().equals("en")}'>
                <%@ include file="/WEB-INF/jsp/about/book-en.jsp"%>
            </c:when>
            <c:when
                    test='${pageContext.response.locale.getLanguage().equals("es")}'>
                <%@ include file="/WEB-INF/jsp/about/book-es.jsp"%>
            </c:when>
            <c:otherwise><%@ include file="/WEB-INF/jsp/about/book-pt.jsp"%></c:otherwise>
        </c:choose>
    </div>
    <!-- apoios info -->
