...
a better understanding of the materials and interactions available in each interface. Tutorials 7, 8, 9 and 10 are
...
<ul>
	...
	<li><a href="#V3">Tutorial 3: Reading</a> [PT]</li>
	<li><a href="#V4">Tutorial 4: Documents</a> [PT]</li>
	<li><a href="#V5">Tutorial 5: Editions</a> [PT]</li>
	<li><a href="#V6">Tutorial 6: Search</a> [PT]</li>
	<li><a href="#V7">Tutorial 7: What is a Virtual Edition?</a> [PT]</li>
	<li><a href="#V8">Tutorial 8: Planning virtual editions</a> [PT]</li>
	<li><a href="#V9">Tutorial 9: Creating virtual editions</a> [PT]</li>
	<li><a href="#V10">Tutorial 10: Taxonomy and annotations</a> [PT]</li>
</ul>


<br />
<h5 id="V1">Tutorial 1: What is the <em>LdoD Archive</em>? [PT]</h5>
...
<h5 id="V2">Tutorial 2: Getting to know the <em>LdoD Archive</em> [PT]</h5>
...
<p><strong>2020</strong> </p>
	...
	<p>Cec&iacute;lia Magalh&atilde;es, &ldquo;Sess&otilde;es Online Arquivo LdoD: 1. Introdu&ccedil;&atilde;o ao Arquivo LdoD&rdquo;, 13/05/2020, 20h00-21h30. 
		...
		Cec&iacute;lia Magalh&atilde;es and Liliana Vasques, &ldquo;Sess&otilde;es Online Arquivo LdoD: 3. Oficina LdoD Remix&rdquo;, 27/05/2020, 20h00-21h30.</p> 
