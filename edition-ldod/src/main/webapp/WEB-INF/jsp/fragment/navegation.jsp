        ...
        <table width="100%">
            ...
            <c:forEach var="virtualEditionInter"
                ...
                <tr>
                    ...
                    <td><a
                            href="${contextPath}/fragments/fragment/${virtualEditionInter.getFragmentXmlId()}/inter/${virtualEditionInter.getUrlId()}/prev"><span
                            class="glyphicon glyphicon-chevron-left"></span></a></td>
                    <td><a
                            href="${contextPath}/fragments/fragment/${virtualEditionInter.getFragmentXmlId()}/inter/${virtualEditionInter.getUrlId()}">${virtualEditionInter.number}</a>
                    </td>
                    <td><a
                            href="${contextPath}/fragments/fragment/${virtualEditionInter.getFragmentXmlId()}/inter/${virtualEditionInter.getUrlId()}/next"><span
                            class="glyphicon glyphicon-chevron-right"></span></a></td>
                    <td></td>
                </tr>
            </c:forEach>
