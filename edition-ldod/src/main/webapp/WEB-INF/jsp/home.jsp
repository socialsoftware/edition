    ...
    <div class="about font-monospace">
        ...
        <c:choose>
            <c:when test="${pageContext.response.locale.language.equalsIgnoreCase('pt')}">
                <p>
                    O Arquivo LdoD � um arquivo digital colaborativo do <span class="s-ws">Livro do Desassossego</span>
                    de <span class="s-ws">Fernando Pessoa</span>.
                    ...
                    Al�m da <span class="s-underl">leitura</span> e <span class="s-underl">compara��o</span> das
                    transcri��es, o Arquivo LdoD permite que os
                    utilizadores colaborem na cria��o de <span class="s-underl">edi��es virtuais</span> do Livro do
                    Desassossego.
                </p>
            </c:when>
            <c:when test="${pageContext.response.locale.language.equalsIgnoreCase('en')}">
                <p>
                    The LdoD Archive is a collaborative digital archive of the Book of Disquiet by Fernando Pessoa. It
                    contains images of the autograph documents, new transcriptions of those documents and also
                    transcriptions of four editions of the work. In addition to reading and comparing transcriptions,
                    the LdoD Archive enables users to collaborate in creating virtual editions of the Book of Disquiet.
                </p>
            </c:when>
            <c:when test="${pageContext.response.locale.language.equalsIgnoreCase('es')}">
                <p>
                    El Archivo LdoD es un archivo digital colaborativo del Libro del desasosiego de Fernando Pessoa.
                    Contiene im�genes de los documentos originales, nuevas transcripciones de estos documentos y
                    transcripciones de cuatro ediciones de la obra. Adem�s de la lectura y la comparaci�n de las
                    transcripciones, el Archivo LdoD permite a los usuarios colaborar en la creaci�n de ediciones
                    virtuales del Libro del desasosiego.
                </p>
            </c:when>
