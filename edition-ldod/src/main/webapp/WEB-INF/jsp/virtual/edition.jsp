...
<head>
    ...
    <script>
        ...
        editionDataItem.fragment = ${inter.getFragmentDto().getExternalId()};
...
<div class="navbar subnav" role="navigation">
    <div class="navbar-inner">
        <div class="container">
                            ...
                            <div class=".form-horizontal " style="width: 140px">
                                ...
                                <div class="col-sm-6"
                                    ...
                                    <button onclick="moveFragments()"
                                            class="btn btn-default btn-block" id="moveok">OK
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <span class="glyphicon glyphicon-text-height" aria-hidden="Adicionar sec��o"></span>
            </button>
          </div>
            ...
            <span class="glyphicon glyphicon-th-list" aria-hidden="Previsualizar �ndice"></span>
            </button>
          </div>
                 -->
                    <!--
                    ...
                    <div class="col-sm-3">
                        <div class="tip" title="text div">
                            <select class="selectpicker" data-width="100%" id="searchType"
                                ...
                                <option value="title">Pesquisa por t�tulo</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Adicionar Sec��o</h4>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Edi��o Virtual</h4>
            </div>
...
<script>
    ...
    function addNewFragment(externalid, name, edition, fragExternalId) {
        var item = {
            date: "",
            fragment: fragExternalId,
            edition: edition,
            link: "link",
            tax: "",
            usedExternalId: externalid,
            name: name,
            complete: false,
            h: 0
        };
