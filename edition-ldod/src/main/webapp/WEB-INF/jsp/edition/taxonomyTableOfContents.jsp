        ...
        <c:forEach var="category" items='${taxonomy.getCategoriesSet()}'>
            <tr>
                ...
                <td><c:forEach var="user"
                    ...
                    <a href="${contextPath}/edition/user/${user.getUsername()}">${user.firstName} ${user.lastName}
                        (${user.getUsername()})</a>
                    <br>
                </c:forEach></td>
                ...
                <td><c:forEach var="inter"
                    ...
                    <a
                            href="${contextPath}/fragments/fragment/${inter.getFragmentXmlId()}/inter/${inter.getUrlId()}">
                            ${inter.getTitle()}</a>
                    <br>
                </c:forEach></td>
            </tr>
