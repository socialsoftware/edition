...
public abstract class DomainRoot_Base extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject {
    ...
    public final static pt.ist.fenixframework.dml.runtime.RoleOne<pt.ist.fenixframework.DomainRoot,pt.ist.socialsoftware.edition.ldod.domain.LdoD> role$$ldoD = new pt.ist.fenixframework.dml.runtime.RoleOne<pt.ist.fenixframework.DomainRoot,pt.ist.socialsoftware.edition.ldod.domain.LdoD>() {
        @Override
        public pt.ist.socialsoftware.edition.ldod.domain.LdoD getValue(pt.ist.fenixframework.DomainRoot o1) {
            return ((DomainRoot_Base.DO_State)o1.get$obj$state(false)).ldoD;
        }
        @Override
        public void setValue(pt.ist.fenixframework.DomainRoot o1, pt.ist.socialsoftware.edition.ldod.domain.LdoD o2) {
            ((DomainRoot_Base.DO_State)o1.get$obj$state(true)).ldoD = o2;
        }
        public pt.ist.fenixframework.dml.runtime.Role<pt.ist.socialsoftware.edition.ldod.domain.LdoD,pt.ist.fenixframework.DomainRoot> getInverseRole() {
            return pt.ist.socialsoftware.edition.ldod.domain.LdoD.role$$root;
        }
    ...
    private final static class DomainRootHasLdoDApplication {
        private static final pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ist.socialsoftware.edition.ldod.domain.LdoD> relation = new pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ist.socialsoftware.edition.ldod.domain.LdoD>(role$$ldoD, "DomainRootHasLdoDApplication");
    }
    public static pt.ist.fenixframework.dml.runtime.DirectRelation<pt.ist.fenixframework.DomainRoot,pt.ist.socialsoftware.edition.ldod.domain.LdoD> getRelationDomainRootHasLdoDApplication() {
        return DomainRootHasLdoDApplication.relation;
    }
    
    static {
        DomainRootHasLdoDApplication.relation.setRelationName("pt.ist.fenixframework.DomainRoot.DomainRootHasLdoDApplication");
    }
    ...
    public void setLdoD(pt.ist.socialsoftware.edition.ldod.domain.LdoD ldoD) {
        getRelationDomainRootHasLdoDApplication().add((pt.ist.fenixframework.DomainRoot)this, ldoD);
    }
