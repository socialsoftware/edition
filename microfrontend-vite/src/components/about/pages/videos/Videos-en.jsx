...
export default ({ scroll, posY }) => {
  ...
  <>
    ...
    <p>
      ...
      in August 2017. The interviews were edited according to topics related to
      both the material and editorial history of the <em>Book of Disquiet</em>{' '}
      ...
      texts, and their perception about the current importance and significance
      of the <em>Book of Disquiet</em>. In the case of the editor of the{' '}
      <em>LdoD Archive</em>, the questions centered on the dynamic and
      ...
      which are read, respectively, by Jer&oacute;nimo Pizarro and Teresa Sobral
      Cunha. The topics of each video are referenced through intertitles,
      according to the sequence described below. Recording and editing of all
      videos: Tiago Cravid&atilde;o. Funding: Foundation for Science and
      Technology.
    </p>
    <br />
