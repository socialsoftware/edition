...
const JogoClassificacao = (props) => {
    
    useEffect(() => {
    }, [])

    return (
        <div className="virtual-editions" style={{width:"760px"}}>
            <p className="virtual-body-title" style={{fontWeight:600}}>{props.messages.general_classificationGame}</p>
            <div className="virtual-class" >
                <p>
                    <a style={{color:"#0C4EF6"}} rel="noreferrer" href="https://ldod.uc.pt/classification-game" target="_blank">{props.messages.general_classificationGame_visitWebsite}</a> 
                </p>
                <p>
					...
					Superior Técnico centrada em Crowdsourcing e Gamification no <em>Arquivo
						LdoD</em>, foi criado o jogo <em>LdoD Classification</em> ou <em>Jogo de
				...
				<ol>
					...
					<li>Vá então a Virtual {"->"} Edições Virtuais {"->"} Gerir (escolhe qual a edição que
						quer criar o jogo) {"->"} Jogo de Classificação {"->"} Criar;</li>
				...
				<p style={{paddingBottom:"50px"}}>
					Depois, para jogar, é necessário entrar <a rel="noreferrer" style={{color:"#0C4EF6"}}
					...
					está disponí­vel <a rel="noreferrer" style={{color:"#0C4EF6"}}
