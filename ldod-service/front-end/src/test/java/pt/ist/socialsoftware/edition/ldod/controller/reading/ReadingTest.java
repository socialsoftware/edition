...
import pt.ist.socialsoftware.edition.ldod.frontend.reading.ReadingController;
...
public class ReadingTest {
    ...
    public void startReadEditionTest() throws Exception {
        this.mockMvc.perform(get("/reading/edition/{acronym}/start", PIZARRO_EDITION_ACRONYM)).andDo(print())
	...
	public void readPreviousRecommendedFragmentErrorTest() throws Exception {
		MvcResult mvcResult = this.mockMvc.perform(get("/reading/fragment/{xmlId}/inter/{urlId}","Fr003","Fr003_WIT_ED_CRIT_Z"))
				.andDo(print())
				.andReturn();
		MockHttpSession session = (MockHttpSession) mvcResult
				.getRequest().getSession();
